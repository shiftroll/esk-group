    ...
    var e = {
        5487: function() {
            ...
            window.tram = function(e) {
                ...
                }, p = window, h = "bkwld-tram", E = /[\-\.0-9]/g, g = /[A-Z]/, m = "number", y = /^(rgb|#)/, _ = /(em|cm|mm|in|pt|pc|px)$/, v = /(em|cm|mm|in|pt|pc|px|%)$/, I = /(deg|rad|turn)$/, b = "unitless", O = /(all|none) 0s ease 0s/, T = /^(width|height)$/, w = document.createElement("a"), A = ["Webkit", "Moz", "O", "ms"], C = ["-webkit-", "-moz-", "-o-", "-ms-"], S = function(e) {
                    if (e in w.style)
                        return {
                            dom: e,
                            css: e
                ...
                var P = t.frame = (a = p.requestAnimationFrame || p.webkitRequestAnimationFrame || p.mozRequestAnimationFrame || p.oRequestAnimationFrame || p.msRequestAnimationFrame) && F.bind ? a.bind(p) : function(e) {
                    p.setTimeout(e, 16)
                }
                  , L = t.now = (s = (c = p.performance) && (c.now || c.webkitNow || c.msNow || c.mozNow)) && F.bind ? s.bind(c) : Date.now || function() {
                    return +new Date
                }
                  , M = l(function(t) {
                    function n(e, t) {
        ...
        5756: function(e, t, n) {
            "use strict";
            var r, i, o, u, a, c, s, l, f, d, p, h, E, g, m, y, _, v, I, b, O = window.$, T = n(5487) && O.tram;
            ...
            r.template = function(e, t, n) {
                !t && n && (t = n);
                var i, o = RegExp([((t = r.defaults({}, t, r.templateSettings)).escape || y).source, (t.interpolate || y).source, (t.evaluate || y).source].join("|") + "|$", "g"), u = 0, a = "__p+='";
        ...
        1970: function(e, t, n) {
            ...
            let y = Object.keys(f.QuickEffectIds)
              ...
              , {getAffectedElements: w, getElementId: A, getDestinationValues: C, observeStore: S, getInstanceId: F, renderHTMLElement: N, clearAllStyles: R, getMaxDurationItemIndex: P, getComputedStyle: L, getInstanceOrigin: M, reduceListToGroup: D, shouldNamespaceEventParameter: k, getNamespacedParameterId: x, shouldAllowMediaQuery: j, cleanupHTMLElement: B, clearObjectCache: G, stringifyTarget: V, mediaQueriesEqual: X, shallowEqual: U} = d.IX2VanillaUtils
                        ...
                        s.default)(n, (t, n) => {
                            ...
                            (function({logic: e, store: t, events: n}) {
                                ...
                                s.default)(E, (e, o) => {
                                    ...
                                    (a.actionTypeId === f.ActionTypeConsts.GENERAL_START_ACTION || _(a.actionTypeId)) && es({
                                        store: t,
                                        actionListId: E,
                                        eventId: s
                                    })
                                ...
                                ;
                                Array.isArray(u) ? u.forEach(y) : "string" == typeof u && y(e)
                            }
                            )({
                                logic: u,
                                store: e,
            ...
            function ed({store: e, eventId: t, eventTarget: n, eventStateKey: r, actionListId: o, groupIndex: u=0, immediate: a, verbose: c}) {
                ...
                0 === u && g && u++;
                let m = (0 === u || 1 === u && g) && _(d.action?.actionTypeId) ? d.config.delay : void 0
                  , y = (0,
                i.default)(E, [u, "actionItems"], []);
                if (!y.length || !j(p, l.mediaQueryKey))
                    return !1;
                let v = l.hasBoundaryNodes && n ? h.getClosestElement(n, I) : null
                  , b = P(y)
                  , O = !1;
                return y.forEach( (i, s) => {
            ...
            function eg(e, t) {
                let {active: n, continuous: r, complete: i, elementId: o, actionItem: u, actionTypeId: a, renderType: c, current: s, groupIndex: l, eventId: f, eventTarget: d, eventStateKey: E, actionListId: g, isCarrier: m, styleProp: y, verbose: _, pluginInstance: v} = e
                  , {ixData: I, ixSession: T} = t.getState()
                  , {events: w} = I
                  , {mediaQueries: A=I.mediaQueryKeys} = w && w[f] ? w[f] : {};
                if (!!j(A, T.mediaQueryKey)) {
                    if (r || n || i) {
                        if (s || c === O && i) {
                            t.dispatch((0,
        ...
        8955: function(e, t, n) {
            ...
            let {MOUSE_CLICK: h, MOUSE_SECOND_CLICK: E, MOUSE_DOWN: g, MOUSE_UP: m, MOUSE_OVER: y, MOUSE_OUT: _, DROPDOWN_CLOSE: v, DROPDOWN_OPEN: I, SLIDER_ACTIVE: b, SLIDER_INACTIVE: O, TAB_ACTIVE: T, TAB_INACTIVE: w, NAVBAR_CLOSE: A, NAVBAR_OPEN: C, MOUSE_MOVE: S, PAGE_SCROLL_DOWN: F, SCROLL_INTO_VIEW: N, SCROLL_OUT_OF_VIEW: R, PAGE_SCROLL_UP: P, SCROLLING_IN_VIEW: L, PAGE_FINISH: M, ECOMMERCE_CART_CLOSE: D, ECOMMERCE_CART_OPEN: k, PAGE_START: x, PAGE_SCROLL: j} = s.EventTypeConsts
              , B = "COMPONENT_ACTIVE"
            ...
            let eE = {
                ...
                [S]: {
                    ...
                    handler: ({store: e, element: t, eventConfig: n, nativeEvent: r, eventStateKey: i}, o={
                        ...
                        return y && (_ > .95 || _ < .05) && (_ = Math.round(_)),
                        (u !== s.EventBasedOn.ELEMENT || I || I !== o.elementHovered) && (_ = l ? 1 - _ : _,
                        e.dispatch((0,
                        f.parameterChanged)(v, _))),
                        {
                            elementHovered: I,
                            clientX: p,
                            clientY: h,
                ...
                [L]: {
                    ...
                    handler: ({element: e, store: t, eventConfig: n, eventStateKey: r}, i={
                        ...
                        let {scrollLeft: o, scrollTop: u, scrollWidth: a, scrollHeight: c, clientHeight: l} = er()
                          , {basedOn: d, selectedAxis: p, continuousParameterGroupId: h, startsEntering: E, startsExiting: g, addEndOffset: m, addStartOffset: y, addOffsetValue: _=0, endOffsetValue: v=0} = n;
        ...
        7718: function(e, t, n) {
            ...
            let r = n(7087)
              ...
              , {getItemConfigByKey: g, getRenderType: m, getStyleProp: y} = i.IX2VanillaUtils
              , _ = (e, t) => {
                let n, r, i, u;
                let {position: a, parameterId: c, actionGroups: s, destinationKeys: l, smoothing: f, restingValue: h, actionTypeId: E, customEasingFn: m, skipMotion: y, skipToValue: _} = e
              ...
              , v = (e, t) => {
                let {active: n, origin: r, start: i, immediate: u, renderType: a, verbose: c, actionItem: s, destination: l, destinationKeys: f, pluginDuration: h, instanceDelay: g, customEasingFn: m, skipMotion: y} = e
                  , _ = s.config.easing
              ...
              , I = (e=Object.freeze({}), t) => {
                ...
                case c:
                    {
                        let {instanceId: n, elementId: r, actionItem: i, eventId: u, eventTarget: a, eventStateKey: c, actionListId: s, groupIndex: l, isCarrier: f, origin: d, destination: p, immediate: E, verbose: g, continuous: _, parameterId: v, actionGroups: I, smoothing: b, restingValue: O, pluginInstance: T, pluginDuration: w, instanceDelay: A, skipMotion: C, skipToValue: S} = t.payload
                          , {actionTypeId: F} = i
                          , N = m(F)
                          , R = y(N, F)
                        ...
                        o.set)(e, n, {
                            ...
                            skipMotion: C,
                            skipToValue: S,
                            customEasingFn: Array.isArray(L) && 4 === L.length ? h(L) : void 0
                        })
                    }
                case s:
                    {
        ...
        4124: function(e, t, n) {
            ...
            let {BACKGROUND: h, TRANSFORM: E, TRANSLATE_3D: g, SCALE_3D: m, ROTATE_X: y, ROTATE_Y: _, ROTATE_Z: v, SKEW: I, PRESERVE_3D: b, FLEX: O, OPACITY: T, FILTER: w, FONT_VARIATION_SETTINGS: A, WIDTH: C, HEIGHT: S, BACKGROUND_COLOR: F, BORDER_COLOR: N, COLOR: R, CHILDREN: P, IMMEDIATE_CHILDREN: L, SIBLINGS: M, PARENT: D, DISPLAY: k, WILL_CHANGE: x, AUTO: j, COMMA_DELIMITER: B, COLON_DELIMITER: G, BAR_DELIMITER: V, RENDER_TRANSFORM: X, RENDER_GENERAL: U, RENDER_STYLE: W, RENDER_PLUGIN: $} = a.IX2EngineConstants
            ...
            function ey({config: e, event: t, eventTarget: n, elementRoot: r, elementApi: i}) {
                ...
                if (Array.isArray(s) && s.length > 0)
                    return s.reduce( (e, o) => e.concat(ey({
                        config: {
                            target: o
                        },
                        event: t,
                ...
                let {getValidDocument: l, getQuerySelector: f, queryDocument: p, getChildElements: h, getSiblingElements: E, matchSelector: g, elementContains: m, isSiblingNode: y} = i
                  , {target: _} = e;
                if (!_)
                    return [];
                let {id: v, objectId: I, selector: b, selectorGuids: O, appliesTo: T, useEventTarget: w} = em(_);
                if (I)
            ...
            let ev = /px/
              , eI = (e, t) => t.reduce( (e, t) => (null == e[t.type] && (e[t.type] = eP[t.type]),
            e), e || {})
              , eb = (e, t) => t.reduce( (e, t) => (null == e[t.type] && (e[t.type] = eL[t.type] || t.defaultValue || 0),
            e), e || {});
                ...
                case J:
                    {
                        ...
                        let a = u(e, C)
                          , c = u(e, S);
                        return t = i.config.widthUnit === j ? ev.test(a) ? parseFloat(a) : parseFloat(n.width) : (0,
                        r.default)(parseFloat(a), parseFloat(n.width)),
                        {
                            widthValue: t,
                            heightValue: o = i.config.heightUnit === j ? ev.test(c) ? parseFloat(c) : parseFloat(n.height) : (0,
            ...
            function ej(e, t, n) {
                ...
                let a = u.split(B).map(eo);
                -1 === a.indexOf(r) && o(e, x, a.concat(r).join(B))
            }
            function eB(e, t, n) {
                if (!d.IS_BROWSER_ENV)
                    return;
                ...
                let {getStyle: i, setStyle: o} = n
                  , u = i(e, x);
                if (!!u && -1 !== u.indexOf(r))
                    o(e, x, u.split(B).map(eo).filter(e => e !== r).join(B))
            }
        ...
        5861: function(e, t, n) {
            ...
            let r = n(1185)
              ...
              , {IX2_SESSION_STOPPED: g, IX2_INSTANCE_ADDED: m, IX2_ELEMENT_STATE_CHANGED: y} = i.IX2EngineActionTypes
              , _ = {}
              , v = (e=_, t={}) => {
                switch (t.type) {
                case g:
            ...
            Webflow.require("ix2").init({
                ...
                actionLists: {
                    a: {
                        ...
                        actionItemGroups: [{
                            actionItems: [{
                                ...
                                config: {
                                    ...
                                    duration: 0,
                                    target: {
                                        id: "67e5fc7bc9630d12f1603699|7756cf67-d535-fcf6-947e-1ffca975f35b"
                                    },
                                    xValue: 0,
                                    yValue: null,
                                    xUnit: "px",
                        ...
                        createdOn: 0x195da62b913
                    },
                    "a-2": {
                        id: "a-2",
                        title: "Endless Loop Mobile",
                        actionItemGroups: [{
                            actionItems: [{
                                id: "a-2-n",
                                actionTypeId: "TRANSFORM_MOVE",
